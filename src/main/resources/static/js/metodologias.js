...
function cargarMetodologias(){ 
	var token = localStorage.getItem("Token");
		$.ajax({
			method: "GET",
			url: "https://inversionesdds.herokuapp.com/api/metodologias?token="+token,
...
function aplicar(){
 ...
 // nombreB = nombreB.replace(/ /g,"");
  $.ajax({
    method: "GET",
    url: "https://inversionesdds.herokuapp.com/api/metodologias/aplicar?nombre="+nombreB+"&token="+token,
    contentType: "application/json;charset=UTF-8",
    async: false
    })
    .done(function(data) {
...
function cargarDetalleOrden(){
  ...
  $.ajax({
            method: "GET",
             url: "https://inversionesdds.herokuapp.com/api/condicionesorden?token="+token,
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            async: false
             })
...
function eliminarCondicionOrden(id) { 
    ...
    $.ajax({
      method: "DELETE",
      url: "https://inversionesdds.herokuapp.com/api/condicionesorden?nombre="+nombre+"&token="+token,
      contentType: "application/json;charset=UTF-8",
      dataType: "json",
      async: false
      })
...
function agregarCondicionOrden() { 
    ...
    $.ajax({
      method:"POST",
      url: "https://inversionesdds.herokuapp.com/api/condicionesorden?tipo="+tipo+"&nombre="+nombre+"&inicioIntervalo="+iI+"&finIntervalo="+fI+"&nombreIndicador="+nombreIndicador+"&periodo="+periodo+"&importancia="+importancia+"&token="+token,
      contentType: "application/json;charset=UTF-8",
      dataType: "json",
      async: false
      })
...
function cargarDetalleFiltro(){
  ...
  $.ajax({
            method: "GET",
             url: "https://inversionesdds.herokuapp.com/api/condicionesfiltro?token="+token,
            contentType: "application/json;charset=UTF-8",
            dataType: "json",
            async: false
             })
...
function eliminarCondicionFiltro(id) { 
    ...
    $.ajax({
      method: "DELETE",
      url: "https://inversionesdds.herokuapp.com/api/condicionesfiltro?nombre="+nombre+"&token="+token,
      contentType: "application/json;charset=UTF-8",
      dataType: "json",
      async: false
      })
...
function agregarCondicionFiltro() { 
    ...
    $.ajax({
      method:"POST",
      url: "https://inversionesdds.herokuapp.com/api/condicionesfiltro?tipo="+tipo+"&nombre="+nombre+"&inicioIntervalo="+iI+"&finIntervalo="+fI+"&nombreIndicador="+nombreIndicador+"&periodo="+periodo+"&comparador="+comparador+"&token="+token,
      contentType: "application/json;charset=UTF-8",
      dataType: "json",
      async: false
      })
